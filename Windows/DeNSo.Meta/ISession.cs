...
namespace DeNSo
{
  public interface ISession
  {
    ...
    System.Collections.Generic.IEnumerable<DeNSo.BSon.BSonDoc> Get(string collection, System.Linq.Expressions.Expression<Func<DeNSo.BSon.BSonDoc, bool>> filter = null);
